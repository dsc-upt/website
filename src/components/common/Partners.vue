    ...
    <v-container fluid>
        <v-row align="center" justify="center" class="mb-0">
            <v-col cols="12" md="12" lg="12" sm="12" class="mb-0">
                ...
                <p class="google-font mt-1 mb-0" style="font-size:100%">A very big thank you to all our partners for
                    their continued partnership.</p>
                <p class="google-font mt-0 mb-0" style="font-size:100%">If you’re interested in being showcased
                    throughout , contact <a style="color:#1565C0;text-decoration: none;"
                                            :href="`mailto:${config.generalConfig.email}`">{{ config.generalConfig.email }}</a>
                    to discuss sponsorship opportunities.</p>
            </v-col>
        </v-row>
                ...
                <div class="client-logo ma-0">
                    <a href="https://gdgjalandhar.com" target="_blank">
                        <v-tooltip bottom>
                            ...
                            <span class="google-font">DSC Politehnica University of Timisoara</span>
                        </v-tooltip>
                    </a>
                </div>
            </v-col>
