        ...
        <v-row align="center" justify="center">
            <v-col cols="12" md="3" lg="3" sm="4" class>
                ...
                <p
                    ...
                    style="font-size:95%"
                >Developer Student Clubs (DSCs) are for developers who are interested in learning new technologies.</p>
                <p class="google-font" style="font-size:95%">About some of them</p>
