            ...
            <v-col md="12" sm="12" cols="12" class="py-0 my-0">
                ...
                <v-row class="mb-5 d-md-none d-lg-none" v-if="loader">
                    <v-col
                        ...
                        :key="i"
                    >
                        <v-skeleton-loader ref="skeleton" type="article"
                                           class="mx-auto elevation-1"></v-skeleton-loader>
                    </v-col>
                </v-row>
                <!-- Mobile Loader -->
                <v-row v-if="blogsData.length <=0 && !loader" justify="center" align="center" class="py-3"
