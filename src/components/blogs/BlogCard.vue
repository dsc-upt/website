    ...
    <div>
        <div
            ...
            <div class="pa-3">
                ...
                <v-btn target="_blank" text small :href="data.data.link" class="mb-0 mt-0 google-font"
                       style="color:#1a73e8;text-decoration:none">Read
                </v-btn>
            </div>
            ...
            >
                <v-list-item three-line>
                    <v-list-item-content>
                        ...
                        <v-list-item-title class="mb-1 google-font" style="font-size:120%">
                            {{ data.data.title | summary(20) }}
                        </v-list-item-title>
                        <v-list-item-subtitle class="google-font">{{ data.data.author }}</v-list-item-subtitle>
                        <v-list-item-subtitle class="google-font mb-0"
                                              v-html="$options.filters.summary(filterData(data.data.description),50)"></v-list-item-subtitle>
                    </v-list-item-content>
